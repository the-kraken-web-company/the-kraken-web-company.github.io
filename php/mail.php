...
$toEmail = "me@jonathanlafleur.ca"; // Replace Your Email Address
...
$fromEmail = "no-reply@jonathanlafleur.ca";  // Replace Company's Email Address (preferably currently used Domain Name)
$fromName = "Web Contact"; // Replace Company Name
...
$recaptcha_secret = '6Lepl98SAAAAAMtbGIaz0IY77IUI17CLIyBUtfpF'; // Your Google reCaptcha Secret


/* --------------------------------------------
// Subject
--------------------------------------------- */
$subject = "Une nouvelle communication"; // Your Subject
...
if (
	...
	if (filter_var($toEmail, FILTER_VALIDATE_EMAIL)) {
		...
		$mail->Subject = $subject . ' [' . $_POST['fname'] . ' ' . $_POST['lname'] . ']';
		...
		if (isset($_POST['g-recaptcha-response'])) {
			...
			$forcerecap = !empty($_POST['force_recaptcha']) && $_POST['force_recaptcha'] != 'false';
			...
			$success = "Votre message a bien été envoyé. Je vous contacterai le plus rapidement possible."; // Success Message
